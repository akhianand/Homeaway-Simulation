...
class ReviewForm extends Component {
  ...
  getFieldMapping(key){
    switch(key){
      case 'adl1': return "Address Line 1";
      case 'adl2': return "Address Line 2";
      ...
      case 'placetype': return "Place Type";
      case 'bedrooms': return "Bedrooms";
      case 'bathrooms': return "Bathrooms";
      case 'accomdates': return "Accomodates";
      case 'images': return "Images";
      case 'startDate': return "Start Date";
      case 'endDate': return "End Date";
      case 'currency': return "Currency";
      case 'pricepernight': return "Price per Night";
      case 'minimumstay': return "Minimum Stay";
  ...
  submitProperty = e => {
   ...
   let endDate=this.props.getEndDate();
    ...
    this.checkValidation(data).then( go =>{
      ...
      axios.post("http://localhost:8000/addProperty", formData).then(response => {
    ...
    let imgErr=[{'errorinfield':'images', 'errorType': "Need Minimum 2 Images" }];
  ...
  render() {
    ...
    let errors = this.state.errorMessage.map(ere => {
      return(
         <div><span  className="text-danger">{this.getFieldMapping(ere.errorinfield)} : {ere.errorType} </span><br/></div>
      )
    ...
    let modals = this.state.images.map(image => {
        return(
             <div className="modal fade bd-example-modal-lg" id={"imagemodal"+image.imgCount} yabIndex="-1" role="dialog" >
      ...
      {redirectVar}
        <div className="card sharpEdges shadow-lg">
          <div className="card-body">
            ...
            Bedrooms: {this.state.bedrooms}<br/>
            Bathrooms: {this.state.bathrooms} <br/>
            Accomodates: {this.state.accomdates}<br/>
            <hr/>
            <h4>Images</h4>
            {thumbnails}
            <br/><br/>
          ...
          <hr/>
             ...
             Currency: {this.state.currency}<br/>
             Price per Night: {this.state.pricepernight}<br/>
             Minimum Stay: {this.state.minimumstay}<br/>
             <hr/>
             <div className="row">
