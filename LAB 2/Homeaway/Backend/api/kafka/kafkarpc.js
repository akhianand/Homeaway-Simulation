...
KafkaRPC.prototype.makeRequest = function(topic_name, content, callback) {
  ...
  self.setupResponseQueue(self.producer, topic_name, function() {
    ...
    console.log("setupResponseQueue: Payloads Added");
    self.producer.send(payloads, function(err, data) {
      console.log("setupResponseQueue: Response Recieved");
      if (err) console.log("setupResponseQueue: Error");
      console.log("setupResponseQueue: Data Recieved");
    });
  });
};
